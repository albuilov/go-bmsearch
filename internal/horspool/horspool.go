// Package horspool реализует алгоритм Boyer-Moore-Horspool —
// упрощённую версию Boyer-Moore, использующую только правило Bad Character.
// Даёт хорошее среднее ускорение при низкой сложности реализации.
package horspool
...
// Символы, не встречающиеся в паттерне, получают сдвиг равной длине паттерна.
